...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26481 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26481(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26490 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26490(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26491 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26491(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26494 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26494(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26496 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26496(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26498 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26498(reader);
}
});
...
var G__26614 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
