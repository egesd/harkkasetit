...
var G__26788 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__26788;
continue;
} else {
return ch;
...
var vec__26765 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26765,(0),null);
return (match === s);
});
...
var len__4864__auto___26814 = arguments.length;
var i__4865__auto___26815 = (0);
while(true){
if((i__4865__auto___26815 < len__4864__auto___26814)){
args__4870__auto__.push((arguments[i__4865__auto___26815]));

var G__26816 = (i__4865__auto___26815 + (1));
i__4865__auto___26815 = G__26816;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq26779){
...
return (function() { 
var G__26820__delegate = function (rdr,_){
...
var G__26820 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__26822__i = 0, G__26822__a = new Array(arguments.length -  1);
while (G__26822__i < G__26822__a.length) {G__26822__a[G__26822__i] = arguments[G__26822__i + 1]; ++G__26822__i;}
  _ = new cljs.core.IndexedSeq(G__26822__a,0,null);
} 
return G__26820__delegate.call(this,rdr,_);};
G__26820.cljs$lang$maxFixedArity = 1;
G__26820.cljs$lang$applyTo = (function (arglist__26823){
var rdr = cljs.core.first(arglist__26823);
var _ = cljs.core.rest(arglist__26823);
return G__26820__delegate(rdr,_);
});
