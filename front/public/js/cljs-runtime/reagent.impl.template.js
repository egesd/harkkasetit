...
var G__26696 = o;
reagent.impl.template.goog$module$goog$object.set(G__26696,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__26714__delegate = function (args){
...
while (G__26715__i < G__26715__a.length) {G__26715__a[G__26715__i] = arguments[G__26715__i + 0]; ++G__26715__i;}
  args = new cljs.core.IndexedSeq(G__26715__a,0,null);
} 
return G__26714__delegate.call(this,args);};
...
return G__26714__delegate(args);
});
...
var G__26697 = o;
reagent.impl.template.goog$module$goog$object.set(G__26697,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__26717__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__26717 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__26718__i = 0, G__26718__a = new Array(arguments.length -  0);
while (G__26718__i < G__26718__a.length) {G__26718__a[G__26718__i] = arguments[G__26718__i + 0]; ++G__26718__i;}
  args = new cljs.core.IndexedSeq(G__26718__a,0,null);
} 
return G__26717__delegate.call(this,args);};
G__26717.cljs$lang$maxFixedArity = 0;
G__26717.cljs$lang$applyTo = (function (arglist__26719){
var args = cljs.core.seq(arglist__26719);
return G__26717__delegate(args);
});
...
var G__26698 = props;
var G__26698__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26698,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26698);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26698__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26699 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26699,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26699;
}
})(),id_class);
...
var G__26700 = (cljs.core.count(argv) - first_child);
switch (G__26700) {
case (0):
...
var vec__26701 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26701,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26701,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26701,(2),null);
...
var temp__5757__auto___26725 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5757__auto___26727 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___26727 == null)){
} else {
var key_26728 = temp__5757__auto___26727;
(jsprops.key = key_26728);
}
...
var temp__5757__auto___26756 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___26756 == null)){
} else {
var key_26757 = temp__5757__auto___26756;
(jsprops.key = key_26757);
}
...
var temp__5757__auto___26758 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___26758 == null)){
} else {
var key_26759 = temp__5757__auto___26758;
(jsprops.key = key_26759);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26704_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__26704_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__26705 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26705,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26705,(1),null);
...
break;
default:
var G__26770 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__26771 = compiler;
v = G__26770;
compiler = G__26771;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template26711 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template26711 = (function (opts,id,fn_to_element,parse_fn,meta26712){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26711.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26713,meta26712__$1){
var self__ = this;
var _26713__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26711(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta26712__$1));
}));

(reagent.impl.template.t_reagent$impl$template26711.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26713){
var self__ = this;
var _26713__$1 = this;
return self__.meta26712;
}));

(reagent.impl.template.t_reagent$impl$template26711.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26711.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26711.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template26711.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26711.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26711.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta26712","meta26712",-2018252080,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26711.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26711.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26711");

(reagent.impl.template.t_reagent$impl$template26711.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template26711");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26711.
 */
reagent.impl.template.__GT_t_reagent$impl$template26711 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template26711(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta26712){
return (new reagent.impl.template.t_reagent$impl$template26711(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta26712));
});

}

return (new reagent.impl.template.t_reagent$impl$template26711(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
