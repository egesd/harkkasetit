...
var i_29593 = (0);
while(true){
if((i_29593 < arr.length)){
(arr[i_29593] = null);

var G__29594 = (i_29593 + (1));
i_29593 = G__29594;
continue;
} else {
}
...
var i_29603 = (self__.level + (1));
while(true){
if((i_29603 <= (new_level + (1)))){
(update[i_29603] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_29608 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29608[i]));
} else {
x__$2.forward.push((((i < links_29608.length))?(links_29608[i]):null));
}

if((i < links_29608.length)){
(links_29608[i] = x__$2);
} else {
links_29608.push(x__$2);
}
...
var i_29613 = (0);
while(true){
if((i_29613 <= self__.level)){
var links_29614 = (update[i_29613]).forward;
if((x__$1 === (((i_29613 < links_29614.length))?(links_29614[i_29613]):null))){
(links_29614[i_29613] = (x__$1.forward[i_29613]));

var G__29615 = (i_29613 + (1));
i_29613 = G__29615;
continue;
} else {
var G__29616 = (i_29613 + (1));
i_29613 = G__29616;
continue;
}
} else {
...
var G__29618 = nx;
var G__29619 = (level__$1 - (1));
x = G__29618;
level__$1 = G__29619;
continue;
} else {
var G__29620 = x;
var G__29621 = (level__$1 - (1));
x = G__29620;
level__$1 = G__29621;
continue;
}
