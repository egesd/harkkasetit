goog.provide('harkka.app');
harkka.app.some_component = (function harkka$app$some_component(){
...
harkka.app.mountit = (function harkka$app$mountit(){
return reagent.dom.render.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [harkka.app.some_component], null),document.body);
});

//# sourceMappingURL=harkka.app.js.map
